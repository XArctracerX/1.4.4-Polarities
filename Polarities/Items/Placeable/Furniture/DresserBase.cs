...
{
    public abstract class DresserBase : ModItem
    {
    ...
    public abstract class DresserTileBase : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(MapColor, Lang.GetItemName(ItemID.Dresser));
