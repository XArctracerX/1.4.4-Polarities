...
namespace Polarities.Items.Placeable.MusicBoxes
{
    ...
    {
        public static Dictionary<int, int> musicBoxIndexToItemType = new();
    ...
    public class GigabatMusicBox : MusicBoxBase { public override int Index => 2; public override string MusicName => "Gigabat"; public override Vector3 ActiveLight => new(0.5f); }
