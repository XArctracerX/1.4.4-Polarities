...
namespace Polarities.Items.Pets
{
    ...
    public class RocketSnekPetBuff : ModBuff
    {
        ...
        public override void Update(Player player, ref int buffIndex)
        {
            ...
            {
                Projectile.NewProjectile(player.GetSource_Buff(buffIndex), player.position.X + player.width / 2, player.position.Y + player.height / 2, 0f, 0f, ProjectileType<RocketSnekPet>(), 0, 0f, player.whoAmI, 0f, 0f);
            }
        }
    }
