            ...
            switch (realState)
            {
                case 0:
                    ...
                    if (mountedPlayer.mount._data.idleFrameCount != 0 && mountedPlayer.mount._idleTime >= mountedPlayer.mount._idleTimeNext)
                    {
                        ...
                        int num17 = (int)((mountedPlayer.mount._idleTime - mountedPlayer.mount._idleTimeNext) / num18);
                    ...
                    {
                        if (mountedPlayer.mount._frameCounter > mountedPlayer.mount._data.standingFrameDelay)
                        {
                ...
                case 1:
                    {
                        ...
                        if (num19 >= 0f)
                        {
                            if (mountedPlayer.mount._frameCounter > mountedPlayer.mount._data.runningFrameDelay)
                            {
                ...
                case 3:
                    mountedPlayer.mount._frameCounter += 1f;
                    if (mountedPlayer.mount._frameCounter > mountedPlayer.mount._data.flyingFrameDelay)
                    {
                ...
                case 2:
                    mountedPlayer.mount._frameCounter += 1f;
                    if (mountedPlayer.mount._frameCounter > mountedPlayer.mount._data.inAirFrameDelay)
                    {
                ...
                case 4:
                    ...
                    if (mountedPlayer.mount._frameCounter > mountedPlayer.mount._data.swimFrameDelay)
                    {
                ...
                case 5:
                    {
                        ...
                        if (num21 >= 0f)
                        {
                            if (mountedPlayer.mount._frameCounter > mountedPlayer.mount._data.dashingFrameDelay)
                            {
