    ...
    public class ShadeStormProjectile : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            for (int i = 0; i < numDraws; i++)
            {
                ...
                Color color = new((int)(lightColor.R / 4 * scale + (-64) * (1 - scale)), (int)(lightColor.G / 4 * scale + (-64) * (1 - scale)), (int)(lightColor.B / 4 * scale + (-64) * (1 - scale)));
                float alpha = 0.2f;
