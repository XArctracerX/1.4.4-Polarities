...
namespace Polarities.NPCs.Enemies
{
    public class GreatStellatedSlime : ModNPC
    {
            ...
            if (player.active)
            {
                ...
                else if (midjumpState == 3)
                {
                    if (!hasUsedShotgun)
                    {
                        for (int i = 0; i < 3; i++)
                        {
                            Vector2 value34 = new(Main.screenWidth, Main.screenHeight);
                            ...
                            {
                                Dust.NewDust(NPC.position, NPC.width, NPC.height, DustID.Enchanted_Pink, NPC.velocity.X * 0.5f, NPC.velocity.Y * 0.5f, 150, default, 1.2f);
                            }
                        }
                    }
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            ...
            if (midjumpState == 3 && !hasUsedShotgun)
            {
                ...
                Vector2 origin10 = new(value176.Width / 2f, 10f);
    ...
    public class GreatStellatedSlimeProjectile : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            Vector2 value15 = new(Main.screenWidth, Main.screenHeight);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Rectangle value176 = value175.Frame();
            Vector2 origin10 = new(value176.Width / 2f, 10f);
            Vector2 value177 = new(0f, Projectile.gfxOffY);
            Vector2 spinningpoint = new(0f, -10f);
            float num184 = (float)Main.timeForVisualEffects / 60f;
