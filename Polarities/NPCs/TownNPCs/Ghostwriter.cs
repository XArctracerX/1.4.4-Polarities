    ...
    public class Ghostwriter : ModNPC
    {
        ...
        public override void AddShops()
        {
            ...
            var npcShop = new NPCShop(Type, ShopName)
                ...
                // .Add<SunPixieBook>(Condition.downedSunPixie)
                // .Add<EsophageBook>(Condition.downedEsophage)
                .Add<PlanteraBook>(Condition.DownedPlantera)
                // .Add<ConvectiveWandererBook>(Condition.downedConvectiveWanderer)
